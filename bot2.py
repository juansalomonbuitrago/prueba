...
arbol = {
    ...
    "administrativo": {
     ...
     "administrativo_info": {
        "mensaje": (
            ...
            "[Descargar catálogo](https://www.formacionminerva.com/wp-content/uploads/2026/01/Brochure-auxiliar-Administrativo.pdf)"
            "\n¿Quieres ver otro área? (sí / no)"
        ),
        "opciones": {
            "sí": "inicio",
  ...
  "enfermeria_info": {
        "mensaje": (
            ...
            "[Descargar catálogo](https://www.formacionminerva.com/wp-content/uploads/2026/01/Brochure-Auxiliar-de-enfermeria.pdf)"
              "\n¿Quieres ver otro área? (sí / no)"
        ),
        "opciones": {
            "sí": "inicio",
    ...
    "cajero_info": {
        "mensaje": (
            ...
            "[Descargar catálogo](https://www.formacionminerva.com/wp-content/uploads/2026/01/Brochure-Cajero-Reponedor.pdf)"
            "\n¿Quieres ver otro área? (sí / no)"
        ),
        "opciones": {
            "sí": "inicio",
